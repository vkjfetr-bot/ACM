...
- Single equipment: run ACM\run_acm_simple.ps1 with -TrainCsv, -TestCsv, -Equip. Outputs to acm_artifacts and archives to acm_artifacts\<Equip> including acm_report.html and the brief.
